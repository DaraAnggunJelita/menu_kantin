...
/*
|--------------------------------------------------------------------------
| Halaman Publik (Landing Page dan Pemesanan)
|--------------------------------------------------------------------------
*/
...
Route::middleware(['auth', RoleAdmin::class])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::prefix('minuman')->name('minuman.')->group(function () {
        ...
        Route::get('{id}', [DaraMinumanController::class, 'show'])->name('show');
    ...
    Route::prefix('pemesanan')->name('pemesanan.')->group(function () {
        ...
        Route::post('/pesan', [PemesananController::class, 'store'])->name('pesan.store');
        Route::post('{id}/status', [PemesananController::class, 'updateStatus'])->name('updateStatus');
        Route::put('admin/pemesanan/{id}/status', [PemesananController::class, 'updateStatus'])->name('admin.pemesanan.update');
